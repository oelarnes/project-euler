This folder contains solutions to problems from projecteuler.net. The fffffffffff
...
This is not intended as a repository for solutions to be used by 
...
All solutions and code are authored by me. For example, the 
